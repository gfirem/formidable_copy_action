...
class FormidableCopyActionManager {
	...
	public function required_formidable_pro() {
		...
		<div class="error">
			<p>
				<?php
				_e( '<b>Formidable Copy Action</b> requires that Formidable Pro version 3.0 or greater be installed. Until then, keep plugin activated only to continue enjoying this insightful message.', 'formidable_key_field-locale' );
				?>
			</p>
		</div>
		<?php
